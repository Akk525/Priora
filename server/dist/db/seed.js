...
async function seed() {
    ...
    try {
      ...
      `, [
        ...
        await c.query(`INSERT INTO cards(board_id,column_id,title,description,assignee_id,priority,category_id,due_date,completed_at,position,archived,estimate_hours) VALUES
